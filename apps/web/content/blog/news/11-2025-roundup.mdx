...
We now have an official ATL Steam group, and we’d love for you to join - it’s invite only and you can find the link [here](https://steamcommunity.com/groups/allthingslinux). Stay tuned for some potential events in the future _wink wink_!

# Additional security and policy notices

November also had a high volume of critical updates:

- A major Chat Control policy update and renewed community action campaign
- A global Cloudflare outage that temporarily impacted ATL services
- A GrapheneOS pressure/relocation notice shared for ecosystem awareness and
  support
