/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env local --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 459740c940200f09d37222171010eb0b)
// Runtime types generated with workerd@1.20251210.0 2025-01-02 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    NEXT_CACHE_DO_PURGE: DurableObjectNamespace<
      import("./.open-next/worker").BucketCachePurge
    >;
    ...
    NEXT_PUBLIC_API_URL:
      | "https://allthingslinux.dev/api"
      | "https://allthingslinux.org/api"
