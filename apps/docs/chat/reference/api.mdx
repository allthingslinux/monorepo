...
| `PROSODY_REST_USERNAME` | REST admin username (JID) — _legacy, HTTP Basic_           | `admin@atl.chat`                  |
| `PROSODY_REST_PASSWORD` | REST admin password — _legacy, HTTP Basic_                 | `change_me_prosody_rest_password` |
