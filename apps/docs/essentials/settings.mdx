...
description: "Use docs.json to set theme, colors, logo, navigation tabs, SEO, and API settings for this site"
icon: "gear"
---
...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages in the [API playground overview](https://mintlify.com/docs/api-playground/overview).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more in the [API playground overview](https://mintlify.com/docs/api-playground/overview)
        </ResponseField>
      </Expandable>
    </ResponseField>
