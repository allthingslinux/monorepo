...
This project uses **Ultracite** (Oxlint + Oxfmt) for automated formatting and linting. Run `pnpm fix` to auto-fix most issues. These rules cover what the linter can't enforce automatically.
